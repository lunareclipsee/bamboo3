		...
		<div class="col-md-9 inner">
			<form method="post" id="modify_confirm" name="modify_confirm">
				...
				<div class="pull-right">
					<input type="button" class="btn btn-default" onClick="location.href = 'postSelect.do?idx=${boardDto.idx}'" value="취소">
					<input type="button" id="postEditBtn" class="btn btn-primary" value="수정하기">
