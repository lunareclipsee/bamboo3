		...
		<div class="col-md-9 inner" style="width: 500px;">
			<div id="pwdCheckBox" class="col-md-9 inner" style="padding-top: 25px;">
				...
				<form action="" id="selectForm" name="formName" method="post">
					...
					<div class="pwdBox">
						<input type="password" id="password" name="password" class="form-control" value="" maxlength="10" onkeyup="enterkey();" autofocus="autofocus">
					</div>
					
					<input type="hidden" id="url" value="${URL}">
					<input type="hidden" id="id" name="id" value="${userInfo.id}"> 
					<input type="hidden" id="name" name="name" value="${userInfo.name}"> 
					<input type="button" class="btn btn-default btn-lg btnmargin pull-left" value="뒤로가기" onClick="location.href = './myPage.do'">
